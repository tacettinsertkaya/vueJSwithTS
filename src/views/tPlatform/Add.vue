        ...
        <div class="grid-content">
          <div class="input-group mb-3">
            ...
            <input
              ...
              placeholder
              aria-label
              v-model="requestTPlatformAdd.TPlatformID"
              max="999"
              min="0"
        ...
        <div class="grid-content">
          <div class="input-group mb-3">
            ...
            <input
              ...
              placeholder
              aria-label
              v-model="requestTPlatformAdd.TPlatformCode"
      ...
      <el-col>
        <div class="grid-content">
          <div class="input-group mb-3">
            ...
            <el-select
              v-model="requestTPlatformAdd.Status"
              filterable
              placeholder="請選擇"
            >
              <el-option
        ...
        <div class="grid-content">
          <div class="input-group mb-3">
            ...
            <input
              ...
              placeholder
              aria-label
              v-model="requestTPlatformAdd.TPlatformName"
        ...
        <div class="grid-content">
          <div class="input-group mb-3">
            ...
            <textarea
              class="form-control"
              :name="'說明'"
              v-model="requestTPlatformAdd.Description"
              cols="100"
              rows="5"
              maxlength="200"
        ...
        <div class="grid-content">
          <div class="input-group mb-3">
            ...
            <textarea
              class="form-control"
              :name="'註解'"
              v-model="requestTPlatformAdd.Comment"
              cols="100"
              rows="5"
              maxlength="200"
              v-validate="{required:false,max:200}"
...
import { RequestTPlatformAdd } from '@/views/tPlatform/model/TPlatformModel'
...
export default class TPlatformAdd extends Vue {
  ...
  requestTPlatformAdd = new RequestTPlatformAdd({
    TPlatformID: 0,
    TPlatformCode: '',
    Status: 1,
    TPlatformName: '',
  ...
  getTPlatform(param) {
    this.requestTPlatformAdd.TPlatformID = param[0]
  }
  async submit(this: any): Promise<void> {
    let allOK = await this.$validator.validateAll()
    if (allOK) {
      if (Object.is(this.requestTPlatformAdd.TPlatformID, -1)) {
        this.$message.error({
      ...
      this.requestTPlatformAdd.TPlatformLangNameDate = this.lagnArray

      TPlatformService.add(this.requestTPlatformAdd)
        .then((response: any) => {
