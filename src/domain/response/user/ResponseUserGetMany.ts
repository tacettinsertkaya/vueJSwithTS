...
interface IResponseUserGetMany {
  UserID: number
  ParentUserID: number
 ...
 * 使用者-多筆
 */
class ResponseUserGetMany extends ResponseBase implements IResponseUserGetMany {
  UserID: number
  ParentUserID: number
  ParentAccount: string
  Account: string
   ...
   * }
   */
  constructor(options: ResponseUserGetMany) {
    super()
...
export default ResponseUserGetMany
