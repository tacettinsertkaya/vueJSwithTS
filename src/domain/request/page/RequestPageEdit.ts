 ...
 * 頁面-編輯
 */
class RequestPageEdit extends RequestBase implements IRequestPageEdit {
  MenuID: number
  MenuType: number
  MenuKeyword: string
  MenuUrl: string
   ...
   * }
   */
  constructor(options: RequestPageEdit) {
    super()
...
export default RequestPageEdit
