 ...
 */
interface IRequestTPlatformAdd {
  TPlatformID: number
 ...
 * 三方平台 - 新增、編輯 一筆
 */
class RequestTPlatformAdd extends RequestBase implements IRequestTPlatformAdd {
  TPlatformID: number
  TPlatformCode: string
  Status: number
  TPlatformName: string
  ...
  Description: string
  Comment: string
  constructor(options: RequestTPlatformAdd) {
    super()
...
export default RequestTPlatformAdd
